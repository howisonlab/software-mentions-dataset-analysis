...
type PaperId struct {
	...
	Id1       uint64         `protobuf:"fixed64,1,opt,name=id1,proto3" json:"id1,omitempty"` // json = "id[0:16]"
	Id2       uint64         `protobuf:"fixed64,2,opt,name=id2,proto3" json:"id2,omitempty"` // json = "id[16:32]"
	Doi       string         `protobuf:"bytes,3,opt,name=doi,proto3" json:"doi,omitempty"`
	Arxiv     string         `protobuf:"bytes,4,opt,name=arxiv,proto3" json:"arxiv,omitempty"`
	PmId      uint32         `protobuf:"fixed32,5,opt,name=pm_id,json=pmId,proto3" json:"pm_id,omitempty"`                        // json = "pmid"
	PmcId     uint32         `protobuf:"fixed32,6,opt,name=pmc_id,json=pmcId,proto3" json:"pmc_id,omitempty"`                     // json = "pmcid"
	IstexId1  uint64         `protobuf:"fixed64,7,opt,name=istex_id1,json=istexId1,proto3" json:"istex_id1,omitempty"`            // json = "istexId[0:16]"
	IstexId2  uint64         `protobuf:"fixed64,8,opt,name=istex_id2,json=istexId2,proto3" json:"istex_id2,omitempty"`            // json = "istexId[16:32]"
	IstexId3  uint32         `protobuf:"fixed32,9,opt,name=istex_id3,json=istexId3,proto3" json:"istex_id3,omitempty"`            // json = "istexId[32:40]"
	Resources []ResourceType `protobuf:"varint,10,rep,packed,name=resources,proto3,enum=ResourceType" json:"resources,omitempty"` // json = "resources"
	License   LicenseType    `protobuf:"varint,11,opt,name=license,proto3,enum=LicenseType" json:"license,omitempty"`             // json = "license"
	OaLink    string         `protobuf:"bytes,12,opt,name=oa_link,json=oaLink,proto3" json:"oa_link,omitempty"`
}
...
func (x *PaperId) GetPmcId() uint32 {
	if x != nil {
		return x.PmcId
	}
	return 0
...
func (x *PaperId) GetIstexId1() uint64 {
	if x != nil {
		return x.IstexId1
	}
	return 0
...
func (x *PaperId) GetIstexId2() uint64 {
	if x != nil {
		return x.IstexId2
	}
	return 0
...
func (x *PaperId) GetIstexId3() uint32 {
	if x != nil {
		return x.IstexId3
	}
	return 0
...
var file_papers_id_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x6e, 0x73, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x4c, 0x69, 0x63,
	0x65, 0x6e, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x07, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73,
	0x65, 0x12, 0x17, 0x0a, 0x07, 0x6f, 0x61, 0x5f, 0x6c, 0x69, 0x6e, 0x6b, 0x18, 0x0c, 0x20, 0x01,
